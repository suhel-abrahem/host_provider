...
import 'package:hosta_provider/core/enums/psition_enum.dart';
                                    ...
                                    listener: (context, state) {
                                      state.when(
                                        ...
                                        loaded: (bookings) {
                                          ...
                                          showMessage(
                                            message: LocaleKeys.common_success
                                                .tr(),
                                            context: context,
                                          );
                                                                    ...
                                                                    child: Form(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          CustomInputField(
                                                                            outerLabel:
                                                                                LocaleKeys.bookingPage_additionalCost.tr(),
                                                                            haveOuterLabel:
                                                                                true,
                                                                            outerLabelPosition:
                                                                                Position.upper,
                                                                          ...
                                                                          CustomInputField(
                                                                            outerLabel:
                                                                                LocaleKeys.bookingPage_additionalCostNotes.tr(),
                                                                            haveOuterLabel:
                                                                                true,
                                                                            outerLabelPosition:
                                                                                Position.upper,

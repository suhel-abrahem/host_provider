...
mixin _$ServiceModel {
 ...
 int? get service_id; bool? get is_active; int? get price; String? get notes; String? get duration_minutes; String? get buffer_minutes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,service_id,is_active,price,notes,duration_minutes,buffer_minutes);

@override
String toString() {
  return 'ServiceModel(service_id: $service_id, is_active: $is_active, price: $price, notes: $notes, duration_minutes: $duration_minutes, buffer_minutes: $buffer_minutes)';
}
...
@useResult
$Res call({
 int? service_id, bool? is_active, int? price, String? notes, String? duration_minutes, String? buffer_minutes
});
...
/// Create a copy of ServiceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? service_id = freezed,Object? is_active = freezed,Object? price = freezed,Object? notes = freezed,Object? duration_minutes = freezed,Object? buffer_minutes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? service_id,  bool? is_active,  int? price,  String? notes,  String? duration_minutes,  String? buffer_minutes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServiceModel() when $default != null:
return $default(_that.service_id,_that.is_active,_that.price,_that.notes,_that.duration_minutes,_that.buffer_minutes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? service_id,  bool? is_active,  int? price,  String? notes,  String? duration_minutes,  String? buffer_minutes)  $default,) {final _that = this;
switch (_that) {
case _ServiceModel():
return $default(_that.service_id,_that.is_active,_that.price,_that.notes,_that.duration_minutes,_that.buffer_minutes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? service_id,  bool? is_active,  int? price,  String? notes,  String? duration_minutes,  String? buffer_minutes)?  $default,) {final _that = this;
switch (_that) {
case _ServiceModel() when $default != null:
return $default(_that.service_id,_that.is_active,_that.price,_that.notes,_that.duration_minutes,_that.buffer_minutes);case _:
  return null;
...
class _ServiceModel implements ServiceModel {
  const _ServiceModel({this.service_id = 0, this.is_active = false, this.price = 0, this.notes = "", this.duration_minutes = "", this.buffer_minutes = ""});
...
/// Create a copy of ServiceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? service_id = freezed,Object? is_active = freezed,Object? price = freezed,Object? notes = freezed,Object? duration_minutes = freezed,Object? buffer_minutes = freezed,}) {

                                                                    ...
                                                                    content: Form(
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          CustomInputField(
                                                                            label:
                                                                                LocaleKeys.categoryServices_price.tr(),
                                                                            initialValue:
                                                                                setServiceModel?.serviceModel?.price.toString(),
                                                                            onChanged:
                                                                                (
                                                                                  value,
                                                                                ) {
                                                                          ...
                                                                          CustomInputField(
                                                                            label:
                                                                                LocaleKeys.categoryServices_bufferInMinutes.tr(),
                                                                            initialValue:
                                                                                setServiceModel?.serviceModel?.buffer_minutes.toString(),
                                                                            onChanged:
                                                                                (
                                                                                  value,
                                                                                ) {
                                                                    ...
                                                                    actions: [
                                                                      AddButton(
                                                                        ...
                                                                        validator:
                                                                            ...
                                                                            setServiceModel?.serviceModel?.price !=
                                                                                0 &&
                                                                            setServiceModel?.serviceModel?.duration_minutes !=
                                                                                null &&
                                                                            setServiceModel?.serviceModel?.duration_minutes !=
                                                                                0,
                                                                      ),
